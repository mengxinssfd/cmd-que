...
(function () {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, utils_1.findDir("./", config.exclude, function (p) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, utils_1.findDirBFS("./", config.exclude, function (p) {
                            var raw = String.raw(templateObject_2 || (templateObject_2 = __makeTemplateObject(["", ""], ["", ""])), p);
                            // return /index\.js$/.test(raw);
                            return /index\.js$/.test(raw);
                        })];
                case 2:
